function prediction = cir_prediction(prior, likelihood, ap, al, wp, wl)
    % Calculates the prediction of the Circular Inference - Reverberation
    ...
    % I is the amount by which both signals are corrupted
    I = fPrior .* fLikelihood;

    % combining corrupted prior and likelihood information
    posteriorSignal = ((likelihoodWithComplement .* I) * wlMatrix) .* ...
                      ((priorWithComplement .* I) * wpMatrix);
